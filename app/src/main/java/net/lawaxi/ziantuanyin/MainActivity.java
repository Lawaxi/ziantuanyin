...
public class MainActivity extends AppCompatActivity {
    ...
    public static ArrayList<Shengpang> data = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (EditText) findViewById(R.id.shit);
        show = (TextView) findViewById(R.id.q);
        s = new Runnable() {
            @Override
            public void run() {
                String a = ZHConverter.convert(text.getText().toString(), ZHConverter.TRADITIONAL)
                        .replace("覷", "覰")
                        .replace("璿", "璇")
                        .replace("濬", "浚")
                        .replace("媫","婕")
                ...
                data.putString("a", a);
                data.putString("b", found_sp.toString().substring(1, found_sp.toString().length() - 1).replace(", ", ""));
                if (found_hsp.isEmpty())
                    data.putBoolean("containsHalf", false);
                else {
                    data.putBoolean("containsHalf", true);
                    data.putString("c", found_hsp.toString().substring(1, found_hsp.toString().length() - 1).replace(", ", ""));
                }
                msg.setData(data);
        ...
        ((Button) findViewById(R.id.ybb)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ((Button) findViewById(R.id.ttt)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                count++;
                if (count % 3 == 0)
    ...
    public static final String s1(String pre) {
        String a = pre;
        return a;
    }
    ...
    private static final void initData() {
        ...
        addDatum("即", true, new String[]{"䳭", "𪠂", "唧", "𠨞", "𡖖", "𡷦", "𡸎", "𪪗", "𭅼", "𣌸", "𪺜", "堲", "揤", "𠨠", "𣹜", "䐚", "楖", "節", "𣩃", "𪡰", "𭅽", "𮔕", "𥠈", "莭", "蝍", "鲫", "𣁚", "莭", "𨂢", "䳭", "鯽", "𪃹","癤","櫛","擳","蠞"});
        ...
        addDatum("辛", true, new String[]{"莘","𬨖", "𠉄", "㛙", "垶", "骍", "𢓫", "𣐽", "𨐍", "𨐎", "𬯁", "𭍤", "𭝅", "𭡄", "𣇛", "𣓀", "𤈼", "𤙡", "𦛛", "𨐏", "𨐑", "𬍧", "𬨘", "锌", "𤽮", "𥏔", "𥞽", "𨐒", "𨐓", "𪿢", "𫐚", "𬨗", "𬨙", "𥭴", "𦀓", "𦐹", "𧗶", "𨐔", "𨐕", "𨐖", "𨐗", "𫋁", "𫐛", "𮇞", "辞", "䛨", "觪", "𦑒", "𧱏", "𨁅", "𨌍", "𨐘", "𨐙", "𨐚", "𨐛", "𬪬", "鋅", "𤨘", "𨐜", "𨐝", "𨐞", "𨴲", "𮝼", "辥", "𨐠", "𨐡", "𨐣", "𨐤", "𨐥", "𨐦", "𮧝", "𮨬", "騂", "𥋑", "𨐩", "𨐪", "𨐮", "𩷔", "𮝽", "𨐶", "𨐷", "𨐸", "𨐺", "𫐝", "𫓅", "𨐿", "𬨛"});
        ...
        addDatum("四", false, new String[]{"伵", "囧", "呬", "怬", "𢏎", "𢪾", "𣳉", "𪯣", "𮕳", "𥹊", "𥿖", "𧣛", "𫪸", "駟"});
        ...
        addDatum("衣",false,new String[]{"褏","衺","褻","祆"});
        addDatum("芻",false,new String[]{"騶","趨"});
        addDatum("生",false,new String[]{"性","姓"});
        ...
        addDatum("旬", true, new String[]{"詢", "峋", "恂", "洵", "郇", "殉", "荀", "狥", "徇", "栒"}, true);
        addDatum("覃", false, new String[]{ "蕈"}, true);
        addDatum("雋", true, new String[]{"鐫", "儁", "寯"}, true);
        addDatum("糸", false, new String[]{"緒", "絮", "續","細","纚","繻","絕","遜"}, true);
        addDatum("宣", true, new String[]{"瑄", "揎", "渲"}, true);
        addDatum("川", false, new String[]{"紃", "巡"}, true);
        addDatum("聿", false, new String[]{"津"},true);
        addDatum("契", false, new String[]{"褉","揳","楔"},true);
        addDatum("世", false, new String[]{"紲","緤","渫"},true);
        addDatum("僉",true,new String[]{"簽"},true);
    ...
    private static final void addDatum(String shengpang, boolean containItself, String[] contains, boolean isHalf) {
        data.add(new Shengpang(shengpang, containItself, contains, isHalf));
    }
